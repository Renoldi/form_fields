...
import 'package:form_fields_example/state/pages/checkbox_examples_view_model.dart';
...
class CheckboxExamplesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => CheckboxExamplesViewModel(),
      child: Consumer<CheckboxExamplesViewModel>(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  buildResultDisplay(context, l.get('cbNewsletterResult'),
                      viewModel.checkbox2),
                  ...
                  buildResultDisplay(context, l.get('cbSelectedLanguages'),
                      viewModel.checkbox4),
                  ...
                  buildFieldTitle(
                      l.get('cbCustomBorder'), Colors.pink.shade600),
                  FormFieldsCheckbox<String>(
                  ...
                  buildFieldTitle(
                      l.get('cbCustomPadding'), Colors.pink.shade600),
                  FormFieldsCheckbox<String>(
                  ...
                  buildResultDisplay(context, l.get('cbSelectedFeatures'),
                      viewModel.checkbox8),
                  ...
                  buildResultDisplay(context,
                      l.get('cbSelectedCountriesVisited'), viewModel.checkbox6),
