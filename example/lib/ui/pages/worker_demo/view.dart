                              ...
                              children: [
                                  ...
                                  onPressed: () async {
                                    ...
                                    try {
                                      ...
                                      ScaffoldMessenger.maybeOf(
                                        ...
                                        const SnackBar(
                                          content: Text('Started all workers'),
                                        ),
                                      );
                                    } catch (e) {
                                      WorkmanagerService
                                      ...
                                      ScaffoldMessenger.maybeOf(
                                        ...
                                        SnackBar(
                                          content: Text('Start all failed: $e'),
                                        ),
                                      );
                                    } finally {
                                      vm.setLoading(false);
                                ...
                                ElevatedButton.icon(
                                  ...
                                  onPressed: () async {
                                    vm.setLoading(true);
                                    try {
                                      final err = await WorkmanagerService
                                          .instance
                                          .runOnceNowDetailed(
                                            taskName: 'dbg_now',
                                          );
