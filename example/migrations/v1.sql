...
CREATE TABLE IF NOT EXISTS pending_inspections_v1 (
...
CREATE TABLE IF NOT EXISTS master_inspections_v1 (
...
CREATE TABLE IF NOT EXISTS master_inspection_forms_v1 (
  hseFormId TEXT PRIMARY KEY,
  payload TEXT NOT NULL,
  updated_at INTEGER NOT NULL
);
...
-- V2: asset table
CREATE TABLE IF NOT EXISTS asset_v1 (
